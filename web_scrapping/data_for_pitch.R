...
contracts_pitch = read_excel("contracts_pitch.xlsx")
...
pitch_players = data.frame(
  Name = character(), Age = numeric(), Position = character(), Exp_contr = numeric(), 
...
# nrow(contracts_pitch), first:last
...
# first = 698
# last = 2335
write.xlsx(pitch_players, paste0("./current_pitch/current_pitch_", as.character(first), "_", as.character(last), ".xlsx"))


archivos <- list.files("./current_pitch", full.names = TRUE)
...
write.xlsx(pitch_players, "current_pitch.xlsx")
